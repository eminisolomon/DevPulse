...
export const COUNTRIES: Country[] = [
  ...
  { label: 'Uruguay', value: 'UY', icon: '🇺 (Y' },
  { label: 'Uzbekistan', value: 'UZ', icon: '🇺 (Z' },
  // V
  { label: 'Venezuela', value: 'VE', icon: '🇻 (E' },
  { label: 'Vietnam', value: 'VN', icon: '🇻🇳' },
  // Y
  { label: 'Yemen', value: 'YE', icon: '🇾 (E' },
  // Z
  { label: 'Zambia', value: 'ZM', icon: '🇿 (M' },
  { label: 'Zimbabwe', value: 'ZW', icon: '🇿 (W' },
];
