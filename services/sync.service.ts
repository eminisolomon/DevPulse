...
export const syncService = {
  ...
  persistGoal: async (
    ...
    const goalData = {
      ...
      delta: goal.delta,
      averageStatus: goal.average_status,
      cumulativeStatus: goal.cumulative_status,
      customTitle: goal.custom_title || null,
      ...
      improveByPercent: goal.improve_by_percent || null,
      notifiedHalfway,
      notifiedCompleted,
      rangeText: goal.range_text,
      chartData: JSON.stringify(goal.chart_data),
      languages: JSON.stringify(goal.languages),
      projects: JSON.stringify(goal.projects),
      editors: JSON.stringify(goal.editors),
      ignoreDays: JSON.stringify(goal.ignore_days),
      createdAt: goal.created_at,
      modifiedAt: goal.modified_at || null,
